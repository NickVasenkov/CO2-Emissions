...
def objective(trial):
    params = {
        ...
        'n_estimators': trial.suggest_int('n_estimators', 10, 500, step=10), # shall be tuned with learning_rate
        ...
        'subsample': trial.suggest_float('subsample', 0.4, 1.00, step=0.05), # not used by 'exact' tree_method (?)
